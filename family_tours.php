...
<div class="container-fluid mt-2 " >
    <div class="row">
        ...
        <div class="col-11 text-center">
            <span id="text_live">Туры "Семейный отдых и развлечения для детей" </span>
        </div>
    </div>
</div>
<div class="container col-lg-5 col-md-11" id="slide" style="border: 10px solid #4d376a;">
    <img class="img-fluid" src="http://www.modafinilsale.com/data/out/402/234372465-disneyland-wallpaper-desktop.jpg">
    <img class="img-fluid" src="https://i.ytimg.com/vi/S4TAsML5xlI/maxresdefault.jpg">
    <img class="img-fluid" src="https://i.ytimg.com/vi/O7vHJARVfqI/maxresdefault.jpg">
    <img class="img-fluid" src="https://i.pinimg.com/originals/2a/a4/51/2aa4510963e3ed2fbd83886f068bc2e5.jpg">
    <img class="img-fluid" src="https://i.ytimg.com/vi/TPfX-ApkBLI/maxresdefault.jpg">
...
<div class="container col-8 mt-5  text-center">
    <div class="container">
        ...
        <?php if(!isset($_SESSION['logged_user'])):
            ?>
            <a  class="nav-link btn " style="background-color: #4d376a; color: white" data-toggle="modal" data-target="#exampleModalCenter1">
                Регистрация
            </a>
        <?php endif;?>
    </div>
...
<div class="container-fluid">
    ...
    foreach ($find as $specifictours) {
        if ($specifictours['video'] != null and $specifictours['tourname'] != null and $specifictours['type'] === 'family_tours.php') {
            echo '
<div class="container col-lg-7 col-md-11">
              <div class="card  col-lg-12  col-md-12  mt-5 "  id="tours_container_f" style="overflow: hidden;">
  ...
  <iframe class="embed-responsive-item" src="' . $specifictours['video'] . '" allowfullscreen></iframe>
            ...
            echo '<ul class="list-group list-group-flush" id="tours_container_f_ul">
