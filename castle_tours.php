...
<div class="container-fluid mt-2 " >
    <div class="row">
        ...
        <div class="col-11 text-center">
            <span id="text_live">Туры "Средневековые замки Европы"  </span>
        </div>
    </div>
</div>
<div class="container col-lg-5 col-md-11" id="slide" style="border: 10px solid #175f6a;">
    <img class="img-fluid" src="http://epomiru.com/wp-content/uploads/2017/11/neuschwanstein-castle-goroda-zamok-nojsh-1020857.jpg">
    <img class="img-fluid" src="http://fullhdwallpapers.ru/image/city/16818/zamok-v-melburne.jpg">
    <img class="img-fluid" src="http://top5-top10.ru/wp-content/uploads/2017/07/%D0%97%D0%B0%D0%BC%D0%BE%D0%BA-%D0%91%D1%80%D0%B0%D0%BD.jpg">
    <img class="img-fluid" src="http://www.wallpapers4u.org/wp-content/uploads/iasi_romania_lock_building_architecture_28488_1920x1080.jpg">
    <img class="img-fluid" src="http://fullhdwallpapers.ru/image/city/4022/zamok-elts.jpg">
...
<div class="container col-8 mt-5  text-center">
    <div class="container">
        ...
        <?php if(!isset($_SESSION['logged_user'])):
            ?>
            <a  class="nav-link btn " style="background-color: #175f6a; color: white" data-toggle="modal" data-target="#exampleModalCenter1">
                Регистрация
            </a>
        <?php endif;?>
    </div>
...
<div class="container-fluid">
    ...
    foreach ($find as $specifictours) {
        if ($specifictours['video'] != null and $specifictours['tourname'] != null and $specifictours['type'] === 'castle_tours.php') {
            echo '
<div class="container col-lg-7 col-md-11">
              <div class="card  col-lg-12  col-md-12  mt-5 "  id="tours_container_c" style="overflow: hidden;">
  ...
  <iframe class="embed-responsive-item" src="' . $specifictours['video'] . '" allowfullscreen></iframe>
            ...
            echo '<ul class="list-group list-group-flush" id="tours_container_c_ul">
