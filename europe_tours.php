...
<div class="container-fluid mt-2 " >
    <div class="row">
        ...
        <div class="col-11 text-center">
            <span id="text_live">Туры "Европейские города"  </span>
        </div>
    </div>
</div>
<div class="container col-lg-5 col-md-11" id="slide" style="border: 10px solid #3b6a4a;">
    <img class="img-fluid" src="https://images.wallpaperscraft.ru/image/avstriya_vena_viden_vinera_tadzh-mahal_73490_1920x1080.jpg">
    <img class="img-fluid" src="http://www.wallpapers4u.org/wp-content/uploads/budapest_hungary_st_stephens_basilica_buildings_sky_69299_1920x1080.jpg">
    <img class="img-fluid" src="https://images.wallpaperscraft.ru/image/chehiya_czech_most_gorod_praha_prague_praga_79302_1920x1080.jpg">
    <img class="img-fluid" src="http://eurobuildings.info/wallpapers/1920x1080/dubrovnik19201080001.JPG">
    <img class="img-fluid" src="https://images.wallpaperscraft.ru/image/germaniya_korabli_drezden_vecher_11531_1920x1080.jpg">
...
<div class="container col-8 mt-5  text-center">
    <div class="container">
        ...
        <?php if(!isset($_SESSION['logged_user'])):
            ?>
            <a  class="nav-link btn " style="background-color: #3b6a4a; color: white" data-toggle="modal" data-target="#exampleModalCenter1">
                Регистрация
            </a>
        <?php endif;?>
    </div>
...
<div class="container-fluid">
    ...
    foreach ($find as $specifictours) {
        if ($specifictours['video'] != null and $specifictours['tourname'] != null and $specifictours['type'] === 'europe_tours.php') {
            echo '
<div class="container col-lg-7 col-md-11">
              <div class="card  col-lg-12  col-md-12  mt-5 "  id="tours_container_eu" style="overflow: hidden;">
  ...
  <iframe class="embed-responsive-item" src="' . $specifictours['video'] . '" allowfullscreen></iframe>
            ...
            echo ' <a class="btn btn-primary mt-3 mb-3" data-toggle="collapse" href="#' . $specifictours['id'] . '" role="button" aria-expanded="false" aria-controls="' . $specifictours['id'] . '">Открыть расписание тура</a>';
            echo nl2br(' <div class="collapse multi-collapse text-left" id="' . $specifictours['id'] . '"><p class="card-text">' . $specifictours['comments'] . '</p><br><p class="text-center"><a class="btn btn-primary mb-3 " data-toggle="collapse" href="#' . $specifictours['id'] . '" role="button" aria-expanded="false" aria-controls="' . $specifictours['id'] . '">Закрыть расписание тура</a></p></div>');
            $led = R::findOne('tours', "tourname=?", array($specifictours['tourname']));
            $date = $led->date;
            $date_tour=date("d.m.Y", strtotime($date));
            date_default_timezone_set('Russia/Moscow');
            echo '<ul class="list-group list-group-flush" id="tours_container_eu_ul">
